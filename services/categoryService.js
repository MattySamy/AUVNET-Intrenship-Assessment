...
exports.getSubSubCategories = asyncHandler(async (req, res, next) => {
  ...
  const iterator = new CategoryIterator(category);
  const subSubCategories = iterator.getSubSubCategories();

  res.status(200).json({ data: subSubCategories });
});
...
exports.createSubCategories = asyncHandler(async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ msg: "SubCategory created successfully", data: category });
});
...
exports.createSubSubCategories = asyncHandler(async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ msg: "SubSubCategory created successfully", data: subCategory });
});
...
exports.updateSubSubCategory = asyncHandler(async (req, res, next) => {
  ...
  res
    .status(200)
    .json({ msg: "SubSubCategory updated successfully", data: subCategory });
});
...
exports.deleteSubSubCategory = asyncHandler(async (req, res, next) => {
  ...
  res.status(204).json({ data: subSubCategory });
});
